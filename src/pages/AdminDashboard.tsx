              ...
              <SheetContent side="left" className="w-[280px] p-0">
                ...
                <div className="p-3">
                  <div className="grid gap-2">
                    <Button variant={activeTab === "products" ? "royal" : "ghost"} className="justify-start" onClick={() => { setActiveTab("products"); setMobileMenuOpen(false); }}>
                    ...
                    <Button variant={activeTab === "attributes" ? "royal" : "ghost"} className="justify-start" onClick={() => { setActiveTab("attributes"); setMobileMenuOpen(false); }}>
                      <Tag className="w-4 h-4 mr-2" /> Attributes
                    </Button>
                    <Button variant={activeTab === "orders" ? "royal" : "ghost"} className="justify-start" onClick={() => { setActiveTab("orders"); setMobileMenuOpen(false); }}>
                    ...
                    <Button variant={activeTab === "sales" ? "royal" : "ghost"} className="justify-start" onClick={() => { setActiveTab("sales"); setMobileMenuOpen(false); }}>
                    ...
                    <Button variant={activeTab === "delivery-boys" ? "royal" : "ghost"} className="justify-start" onClick={() => { setActiveTab("delivery-boys"); setMobileMenuOpen(false); }}>
